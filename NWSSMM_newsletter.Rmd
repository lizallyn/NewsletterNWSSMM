...
options(gargle_oauth_email = "birdc@oregonstate.edu")
drive_auth(email="birdc@oregonstate.edu")

#make sure that the link to the sheet is correct
df_responses <- read_sheet("https://docs.google.com/spreadsheets/d/1tTIP-HUZuOHWXRFThQsO7wvLhqPxi3yR_GH1ae0GjrU/edit#gid=2106727867", col_types = "c", skip = 1)
```
